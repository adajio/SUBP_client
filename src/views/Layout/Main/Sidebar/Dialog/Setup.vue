  ...
  <Dialog dismissableMask modal :showHeader="false" :breakpoints="{ '960px': '75vw', '640px': '100vw' }"
    ...
    <div class="surface-card shadow-2 border-round p-4">
      <div class="flex align-items-center justify-content-between mb-3">
        <div class="text-900 font-medium text-xl">Настройка</div>
        <div>
    ...
    <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
      <div class="p-fluid flex flex-column lg:flex-row">
        <ul
          ...
          <li>
            <a v-ripple
              ...
              <span class="font-medium hidden md:block">Аккаунт</span>
            </a>
          </li>
          <li>
            <a v-ripple
              class="flex align-items-center cursor-pointer p-3 border-round text-800 hover:surface-hover transition-duration-150 transition-colors p-ripple">
              <i class="pi pi-user md:mr-2"></i>
              <span class="font-medium hidden md:block">Профиль</span>
            </a>
          </li>
          <li>
            <a v-ripple
              ...
              <span class="font-medium hidden md:block">Уведомления</span>
            </a>
          </li>
          <Divider></Divider>
          ...
          <li>
            <a v-ripple
              ...
              <span class="font-medium hidden md:block">Типы</span>
            </a>
          </li>
          ...
          <li>
            <a v-ripple
              ...
              <span class="font-medium hidden md:block">Статусы</span>
            </a>
          </li>
          ...
          <li>
            <a v-ripple
              class="flex align-items-center cursor-pointer p-3 border-round text-800 hover:surface-hover transition-duration-150 transition-colors p-ripple">
              <i class="pi pi-bell md:mr-2"></i>
              <span class="font-medium hidden md:block">Коллекции</span>
            </a>
          </li>
        ...
        <div class="surface-card p-5 shadow-2 border-round flex-auto">
          <div class="text-900 font-semibold text-lg mt-3">Профиль</div>
          <Divider></Divider>
...
<script setup>
import { ref } from 'vue';
import SetupTypes from './Setup/Types.vue';
import SetupStatuses from './Setup/Statuses.vue';
